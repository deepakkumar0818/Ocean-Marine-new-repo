...
export default function AuditSubContractorListAdminPage() {
  ...
  const fetchAudits = async () => {
    ...
    try {
      ...
      const submittedAudits = (data.subContractorAudits || []).filter(
        (a) => a.status === "Submitted"
      );
      setAudits(submittedAudits);
      if (selectedAudit) {
        const updated = submittedAudits.find(
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-slate-200 mt-1">
                  Review and approve submitted audit forms.
                </p>
              </div>
            </div>
            <Link
                ...
                <div className="p-6 space-y-6 max-h-[70vh] overflow-y-auto">
                  ...
                  <div className="border-t border-white/10 pt-4 flex justify-end">
                    <button
                      ...
                      disabled={approving === selectedAudit._id}
                    ...
                    >
                      {approving === selectedAudit._id ? "Approving..." : "Approve Form"}
                    </button>
                  </div>
                </div>
              </div>
